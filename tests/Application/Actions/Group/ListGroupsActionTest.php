...
class ListGroupsActionTest extends TestCase
{
    public function testAction()
    {
        ...
        $groups = [
            new Group(1, 'Group 1', '', 'Description 1', 1, new \DateTime(), new \DateTime()),
            new Group(2, 'Group 2', '', 'Description 2', 2, new \DateTime(), new \DateTime())
        ];
        ...
        $request = $this->createRequest('GET', '/groups')->withHeader('Authorization', 'Bearer ' . $token);
